...
$usp_form = '<p>'. $usp_intro_form  . $usp_intro_more . $usp_intro_info .'</p>'. "\n\n" .
'[usp_name]
[usp_email]
[usp_url]
[usp_title]
...
$contact_form = '<p>'. $usp_intro_contact . $usp_intro_more . $usp_intro_info .'</p>'. "\n\n" . 
'[usp_name]
[usp_email]
[usp_url]
[usp_subject]
...
$register_form = '<p>'. $usp_intro_register . $usp_intro_more . $usp_intro_info .'</p>'. "\n\n" . 
'[usp_name]
[usp_url]
[usp_captcha]
[usp_email]'. "\n\n" .
...
$image_form = '<p>'. $usp_intro_images . $usp_intro_more . $usp_intro_info .'</p>'. "\n\n" .
'[usp_title]
[usp_content]
...
$classic_form = '<p>'. $usp_intro_classic . $usp_intro_more . $usp_intro_info .'</p>'. "\n\n" .
'[usp_name]
[usp_url]
[usp_email]
[usp_title]
...
[usp_tags label="Tags" type="dropdown" multiple="false" required="false" include="30"]
...
[usp_category label="Categories" type="dropdown" multiple="false" required="false"]
...
[usp_taxonomy label="People" tax="people" terms="1,2,3,4,5" type="dropdown" multiple="true" required="false"]
